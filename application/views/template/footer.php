                                ...
                                <div class="vertical-timeline-element-content bounce-in">
                                    <h4 class="timeline-title">Something not important
                                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img
                                                        src="<?= base_url('vendor/admin-kero/demo.dashboardpack.com/kero-html-sidebar-pro/') ?>assets/images/avatars/1.jpg"
                                                        alt=""></div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img
                                                        src="<?= base_url('vendor/admin-kero/demo.dashboardpack.com/kero-html-sidebar-pro/') ?>assets/images/avatars/2.jpg"
                                                        alt=""></div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img
                                                        src="<?= base_url('vendor/admin-kero/demo.dashboardpack.com/kero-html-sidebar-pro/') ?>assets/images/avatars/3.jpg"
                                                        alt=""></div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img
                                                        src="<?= base_url('vendor/admin-kero/demo.dashboardpack.com/kero-html-sidebar-pro/') ?>assets/images/avatars/4.jpg"
                                                        alt=""></div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img
                                                        src="<?= base_url('vendor/admin-kero/demo.dashboardpack.com/kero-html-sidebar-pro/') ?>assets/images/avatars/5.jpg"
                                                        alt=""></div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img
                                                        src="<?= base_url('vendor/admin-kero/demo.dashboardpack.com/kero-html-sidebar-pro/') ?>assets/images/avatars/6.jpg"
                                                        alt=""></div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img
                                                        src="<?= base_url('vendor/admin-kero/demo.dashboardpack.com/kero-html-sidebar-pro/') ?>assets/images/avatars/7.jpg"
                                                        alt=""></div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img
                                                        src="<?= base_url('vendor/admin-kero/demo.dashboardpack.com/kero-html-sidebar-pro/') ?>assets/images/avatars/8.jpg"
                                                        alt=""></div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm avatar-icon-add">
                                                <div class="avatar-icon"><i>+</i></div>
...
<!-- Mirrored from demo.dashboardpack.com/kero-html-sidebar-pro/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Feb 2020 00:12:31 GMT -->
</html>
